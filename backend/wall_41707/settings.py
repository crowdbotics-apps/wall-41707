"""
Django settings for wall_41707 project.
...
WSGI_APPLICATION = 'wall_41707.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wall_41707 API",
    "DESCRIPTION": "API documentation for wall_41707 App",
    "VERSION": "v1",
}
